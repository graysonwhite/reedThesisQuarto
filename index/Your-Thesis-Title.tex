...
% Thesis-specific margins for Reed College
...
% Define custom thesis metadata commands
\makeatletter
\def\institution#1{\gdef\@institution{#1}}
\def\division#1{\gdef\@division{#1}}
\def\department#1{\gdef\@department{#1}}
\def\advisor#1{\gdef\@advisor{#1}}
\def\altadvisor#1{\gdef\@altadvisor{#1}}
\def\degree#1{\gdef\@degree{#1}}

% Initialize to empty (so ifdef can check if defined)
\global\let\@institution\@empty
\global\let\@division\@empty
...
% Suppress default \maketitle but preserve title/author/date values
\makeatletter
\renewcommand{\maketitle}{%
  % Do nothing - we use our own title page in before-body.tex
  % Title/author/date remain set from \title{}, \author{}, \date{}
}
\makeatother
...
\maketitle
\begin{abstract}
This is your abstract text. You can write it here directly. It can span
multiple paragraphs.
\end{abstract}

% Reed College Thesis Title Page and Front Matter
\makeatletter
...
\begin{titlepage}
  ...
  A Thesis \\
  Presented to \\
  \ifx\@division\@empty\else The Division of \@division \\\fi
  ...
  \ifx\@degree\@empty Bachelor of Arts\else\@degree\fi
...
\centering
Approved for the \ifx\@department\@empty Division\else\@department\fi

\vskip 1cm

\makebox[3in]{\hrulefill}
\ifx\@altadvisor\@empty\else\makebox[.5in]{} \makebox[3in]{\hrulefill}\fi

\makebox[3in][c]{\ifx\@advisor\@empty\else\@advisor\fi}
\ifx\@altadvisor\@empty\else\makebox[.5in]{} \makebox[3in][c]{\@altadvisor}\fi
...
\chapter{My Final College Paper}\label{my-final-college-paper}
...
\pandocbounded{\includegraphics[keepaspectratio]{01-chap1_files/figure-pdf/unnamed-chunk-2-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{01-chap1_files/figure-pdf/unnamed-chunk-10-1.pdf}}
...
{\centering \includegraphics[width=0.83in,height=\textheight,keepaspectratio]{figure/reed.jpg}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{03-chap3_files/figure-pdf/delaysboxplot-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figure/subdivision.pdf}}
